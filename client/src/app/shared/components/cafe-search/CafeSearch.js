...
import { getOpenTimeAC } from '../../../core/middleware/getOpenTime';
import { getPlacesForDropdownAC } from '../../../core/middleware/getPlacesForDictionary';
import { searchPlacesAC } from '../../../core/middleware/searchPlaces';
import { getPlacesTypesAC } from '../../../core/middleware/getPlacesTypes';
import { saveSearchFormAC } from '../../../core/actions/placesActions';
import searchFormEntryPoints from '../../constants/searchFormEntryPoints';
...
class CafeSearch extends React.PureComponent {
    ...
    state = {
        date: parseInt(this.props.match.params.entry) === searchFormEntryPoints.CATALOG ? this.props.searchForm.date : null,
        timeFrom: parseInt(this.props.match.params.entry) === searchFormEntryPoints.CATALOG ? this.props.searchForm.timeFrom : null,
        timeTo: parseInt(this.props.match.params.entry) === searchFormEntryPoints.CATALOG ? this.props.searchForm.timeTo : null,
        placeId: parseInt(this.props.match.params.entry) === searchFormEntryPoints.CATALOG ? this.props.searchForm.placeId : null,
        placeTypeId: parseInt(this.props.match.params.entry) === searchFormEntryPoints.CATALOG ? this.props.searchForm.placeTypeId : null,
    ...
    onSubmit = () => {
        if (this.state.isFormValid) {
            ...
            this.searchPlaces();
            if (this.props.entryPoint === searchFormEntryPoints.CATALOG) {
                this.props.history.push("/catalog/" + 1);
            } else {
                this.props.history.push("/catalog/" + 1 + '/' + searchFormEntryPoints.CATALOG);
            }
        }
    }
