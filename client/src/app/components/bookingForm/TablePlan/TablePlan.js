...
import OneRowTables from './Table/OneRowTables';
                    ...
                    <Fragment>
                        <div className="container">
                            ...
                            <div style={{ border: "1px solid black" }}>
                                {
                                    slicedTables.map((tableGoup, index) => <OneRowTables key={index} tableGoup={tableGoup} selectedTable={this.state.selectedTable} />)
                                }
                            </div>
                        </div>
